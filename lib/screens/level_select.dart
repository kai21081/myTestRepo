...
class _LevelSelectPageState extends State<LevelSelectPage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> bodyColumnChildren = <Widget>[
      ...
      SizedBox(height: _betweenButtonSpacing),
      _buildPlayGameButton(6, "Level 6", "assets/levels/level6.txt", _heroTagLevel6Button),
      SizedBox(height: _betweenButtonSpacing),
      _buildPlayGameButton(7, "Level 7", "assets/levels/level7.txt", _heroTagLevel7Button),
      SizedBox(height: _betweenButtonSpacing),
      _buildPlayGameButton(8, "Level 8", "assets/levels/level8.txt", _heroTagLevel8Button),
      SizedBox(height: _betweenButtonSpacing),
      _buildPlayGameButton(9, "Level 9", "assets/levels/level9.txt", _heroTagLevel9Button),
      SizedBox(height: _betweenButtonSpacing),
      _buildPlayGameButton(10, "Level 10", "assets/levels/level10.txt", _heroTagLevel10Button),
